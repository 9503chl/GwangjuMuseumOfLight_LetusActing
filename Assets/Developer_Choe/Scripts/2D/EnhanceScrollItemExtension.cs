...
public class EnhanceScrollItemExtension : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    [NonSerialized]
    private EnhanceScrollViewExtension scrollView;
    ...
    public void SetScrollView(EnhanceScrollViewExtension view)
    {
        scrollView = view;
    }
